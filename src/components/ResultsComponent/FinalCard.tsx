          ...
          >
              ...
              <Card className="bg-white dark:bg-black p-4 h-40 flex flex-col justify-between">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 rounded-full overflow-hidden flex-shrink-0 shadow-md">
                    <img src={`https://flagcdn.com/w80/${leaderSong.flag}.png`} alt={`${leaderSong.artistName}'s flag`} className="w-full h-full object-cover" />
                  </div>
            ...
            >
              <Card className="bg-white dark:bg-black p-4 h-40 flex flex-col justify-between">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 rounded-full overflow-hidden flex-shrink-0 shadow-md">
                    <img src={`https://flagcdn.com/w80/${stillToScoreSong.flag}.png`} alt={`${stillToScoreSong.artistName}'s flag`} className="w-full h-full object-cover" />
                  </div>
                  <div className="flex-1 min-w-0">
          ...
          >
            ...
            <Card className="bg-white dark:bg-black p-8 rounded-xl shadow-2xl w-full">
              <div className="w-24 h-24 rounded-full overflow-hidden mx-auto mb-4 shadow-lg">
                <img
                  src={`https://flagcdn.com/w160/${winningSong.flag}.png`}
