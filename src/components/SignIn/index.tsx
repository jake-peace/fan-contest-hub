			...
			<>
				<Card className="mb-4 py-6">
					...
					<CardContent className="justify-items-center max-w-md">
						...
						<div className="mt-2">
							<p className="text-muted-foreground text-sm">Enter the one time code sent to your email.</p>
							<p className="text-muted-foreground text-sm">Not got one? Wait 30 mins or try signing in on the previous screen.</p>
						</div>
					</CardContent>
				</Card>
			</>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>{`Enter your email to receive a one-time code to sign in.`}</FormDescription>
									<FormMessage />
								</FormItem>
							)}
						></FormField>
